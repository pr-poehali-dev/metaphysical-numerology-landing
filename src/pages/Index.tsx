        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="font-golos leading-relaxed flex flex-col gap-3" style={{ color: "var(--warm-mid)", fontSize: "0.9rem" }}>
            ...
            <ul className="flex flex-col gap-2 pl-1">
              ...
              <li className="flex gap-2">
                <span style={{ color: "var(--blush)", flexShrink: 0 }}>•</span>
                <span><strong style={{ color: "var(--warm-dark)" }}>Ритмологию —</strong> расшифровку вашего ФИО через индивидуальную мандалу. Вы узнаете свои сильные стороны, есть ли родовая поддержка, что в имени помогает влиять на пространство, а что мешает достигать целей, и какие уроки вы будете проходить в этом воплощении.</span>
              </li>
            </ul>
            <p>
